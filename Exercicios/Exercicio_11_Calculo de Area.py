...
tinta = metragem / 2
print('A parede descrita tem {:.3f} metros quadrados'.format(metragem))
print('Para realizar a pintura dessa parede é necessario {:.4f} litros de tinta.'.format(tinta))
